...
- Library → Settings → Group
  ...
  <img src=".github/assets/Library-Group.png" alt="Library Group" width="150" />

- Settings → Custom settings → User profiles

  <img src=".github/assets/User-Profiles.png" alt="User Profiles" width="150" />

- Manga merge

  <img src=".github/assets/Manga-merge.gif" alt="Manga merge" width="150" />
- Browse → Feeds
