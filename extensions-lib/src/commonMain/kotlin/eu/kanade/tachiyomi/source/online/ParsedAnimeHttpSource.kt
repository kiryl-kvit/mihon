...
abstract class ParsedAnimeHttpSource : AnimeHttpSource() {
    ...
    /**
     * Returns an anime title from the given [element]. Most sites only show the title and the url,
     * it's totally fine to fill only those two values.
     *
    ...
    /**
     * Returns the details of the anime title from the given [document].
     *
