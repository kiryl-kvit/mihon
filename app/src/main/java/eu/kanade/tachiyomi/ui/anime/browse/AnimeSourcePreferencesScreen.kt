...
import eu.kanade.tachiyomi.source.animeSourcePreferences
...
class AnimeSourcePreferencesScreen(
...
class AnimeSourcePreferencesFragment : PreferenceFragmentCompat() {
    ...
    private fun populateScreen(): PreferenceScreen {
        ...
        if (source is ConfigurableAnimeSource) {
            val dataStore = SharedPreferencesDataStore(source.animeSourcePreferences())
